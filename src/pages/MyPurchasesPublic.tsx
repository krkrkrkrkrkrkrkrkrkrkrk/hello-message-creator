...
loadstring(game:HttpGet("${getFunctionsBaseUrl()}/loader/${purchase.product?.id}"))()`;
  };
              ...
              >
                <div className="flex flex-col lg:flex-row gap-6">
                  ...
                  <div className="flex-1 space-y-4">
                    ...
                    {/* Script Content - Show full script */}
                    {purchase.script_content && (
                      <div className="rounded-lg bg-secondary/50 border border-border p-4">
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center gap-2 text-sm font-medium">
                          ...
                          <Button
                            variant="ghost"
                            size="sm"
                            onClick={() => copyToClipboard(purchase.script_content!, "script", purchase.id)}
                            className="h-8 gap-2"
                          >
                        ...
                        <pre className="text-xs text-muted-foreground font-mono break-all whitespace-pre-wrap max-h-48 overflow-y-auto bg-background/50 rounded p-3">
                          {purchase.script_content}
                        </pre>
                      </div>
                    )}

                    {/* Alternative: Loader Script if no script content */}
                    {!purchase.script_content && purchase.product && (
                      <div className="rounded-lg bg-secondary/50 border border-border p-4">
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center gap-2 text-sm font-medium">
                            <ExternalLink className="w-4 h-4 text-primary" />
