      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold mt-4 mb-6">
            ...
            <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Protect</span> Your Scripts
          </h2>
            ...
            {executorSupport.map((executor, index) => (
              ...
              >
                <Cpu className={`w-6 h-6 mx-auto mb-2 ${
                  executor.status === "full" ? "text-emerald-400" : "text-amber-400"
                }`} />
