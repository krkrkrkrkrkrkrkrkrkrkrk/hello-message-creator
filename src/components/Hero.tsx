...
import { ArrowRight, Shield, Lock, Sparkles, CheckCircle2 } from "lucide-react";
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass mb-8 hover-lift border border-primary/20"
          >
            <motion.div
          ...
          >
            Secure Your{" "}
            <span className="bg-gradient-to-r from-primary via-primary to-accent bg-clip-text text-transparent">Roblox</span>{" "}
            Scripts with{" "}
          ...
          >
            <TrustBadge text="Free forever plan" />
            <TrustBadge text="No credit card required" />
            <TrustBadge text="Setup in 2 minutes" />
          </motion.div>
        ...
        >
          <div className="glass p-4 rounded-xl hover-lift border border-border/50">
