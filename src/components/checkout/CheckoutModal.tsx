...
import { X, CreditCard, Wallet, Bitcoin, Loader2, Lock, Shield, Check, AlertCircle, Sparkles, Tag, ExternalLink } from "lucide-react";
...
const CryptoPaymentForm = ({ 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Payment created! Complete payment in the new tab.");
      onClose();
      navigate(`/payment/pending?order_id=${order_id}`);
    ...
    return (
      ...
      >
        <motion.div
          ...
          className="w-24 h-24 mx-auto mb-8 rounded-full bg-gradient-to-br from-orange-500/20 to-orange-600/10 flex items-center justify-center border border-orange-500/30"
        >
          <motion.div
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
          ...
          >
            <ExternalLink className="w-12 h-12 text-orange-400" strokeWidth={2} />
          </motion.div>
        </motion.div>
        ...
        >
          ...
          <span>Pay with BTC, ETH, USDT, LTC & more</span>
        </motion.div>
      </motion.div>
    );
  }
    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="p-4 rounded-xl bg-orange-500/5 border border-orange-500/20">
        <div className="flex items-center gap-3 mb-3">
          ...
          <span className="text-sm font-medium text-foreground">Supported Cryptocurrencies</span>
        </div>
        <p className="text-xs text-muted-foreground">
          Bitcoin (BTC), Ethereum (ETH), USDT, Litecoin (LTC), Dogecoin (DOGE), and 100+ more cryptocurrencies
        </p>
      </div>
      ...
      <Button
        type="submit"
        disabled={paymentStatus === "processing" || !email || !!emailError}
        className="w-full h-14 text-lg font-semibold relative overflow-hidden group rounded-xl bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700"
      >
        <motion.div
            ...
            <div className="relative bg-card/95 backdrop-blur-xl rounded-2xl p-8 border border-border/50 shadow-2xl overflow-hidden">
                ...
                >
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    ...
                    <motion.button
                      ...
                      className="group relative p-6 rounded-2xl border border-border/50 bg-background/50 hover:border-orange-500/50 hover:bg-orange-500/5 transition-all duration-300 text-left overflow-hidden"
                    >
                      ...
                      <div className="flex items-center gap-4 relative">
                        <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-orange-500/20 to-orange-500/5 flex items-center justify-center border border-orange-500/20 group-hover:border-orange-500/40 transition-colors">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-muted-foreground mt-1">
                            Bitcoin, Ethereum, USDT, LTC & more
                          </p>
                        </div>
                        <div className="w-8 h-8 rounded-full bg-orange-500/10 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
              ...
              {selectedMethod === "crypto" && (
                ...
                >
                  ...
                  <CryptoPaymentForm plan={plan} onClose={handleClose} appliedPromo={appliedPromo} navigate={navigate} />
                </motion.div>
              )}
            </div>
          </motion.div>
