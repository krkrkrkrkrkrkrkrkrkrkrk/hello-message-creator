...
/**
 * SHADOWAUTH validate-key V1 — DEPRECATED
 * ========================================
 * All validation now handled by validate-key-v2.
 * This endpoint returns a deprecation notice and forwards to v2 when possible.
 */
    ...
    try {
      ...
      const v2Response = await fetch(v2Url, {
        ...
        headers: {
          ...
          "x-shadow-sig": req.headers.get("x-shadow-sig") || "",
      ...
      console.error("[v1→v2 forward] Error:", err);
